...
local app = require('neconfig.configuration.apps').default.quake
local client_keys = require('neconfig.configuration.client.keys')
local client_buttons = require('neconfig.configuration.client.buttons')
local quake_id = nil
